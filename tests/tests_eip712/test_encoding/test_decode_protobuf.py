...
def test_decodes_msg_send_payloads():
    ...
    # fmt: on
    eip712 = decode_protobuf_sign_doc(encoded)
...
def test_decodes_msg_vote_payloads():
    # fmt: off
    encoded = bytes([
        10, 83, 10, 81, 10, 27, 47, 99, 111, 115, 109, 111, 115, 46, 103,
        111, 118, 46, 118, 49, 98, 101, 116, 97, 49, 46, 77, 115, 103, 86,
        111, 116, 101, 18, 50, 8, 1, 18, 44, 101, 118, 109, 111, 115, 49,
        56, 116, 97, 121, 122, 104, 116, 97, 51, 118, 120, 102, 107, 102, 100,
        56, 112, 121, 99, 53, 122, 102, 108, 116, 115, 48, 57, 103, 99, 115,
        106, 50, 56, 52, 109, 120, 52, 103, 24, 1, 18, 113, 10, 89, 10,
        79, 10, 40, 47, 101, 116, 104, 101, 114, 109, 105, 110, 116, 46, 99,
        114, 121, 112, 116, 111, 46, 118, 49, 46, 101, 116, 104, 115, 101, 99,
        112, 50, 53, 54, 107, 49, 46, 80, 117, 98, 75, 101, 121, 18, 35,
        10, 33, 3, 139, 151, 41, 107, 90, 157, 51, 96, 53, 119, 92, 215,
        182, 106, 29, 41, 15, 28, 120, 52, 168, 207, 12, 57, 191, 197, 131,
        95, 168, 202, 190, 109, 18, 4, 10, 2, 8, 1, 24, 1, 18, 20,
        10, 14, 10, 6, 97, 101, 118, 109, 111, 115, 18, 4, 50, 48, 48,
        48, 16, 192, 154, 12, 26, 12, 101, 118, 109, 111, 115, 95, 57, 48,
        48, 48, 45, 49,
    ])
    # fmt: on
    eip712 = decode_protobuf_sign_doc(encoded)
...
def test_decodes_msg_delegate_payloads():
    # fmt: off
    encoded = bytes([
        10, 173, 1, 10, 170, 1, 10, 35, 47, 99, 111, 115, 109, 111, 115,
        46, 115, 116, 97, 107, 105, 110, 103, 46, 118, 49, 98, 101, 116, 97,
        49, 46, 77, 115, 103, 68, 101, 108, 101, 103, 97, 116, 101, 18, 130,
        1, 10, 44, 101, 118, 109, 111, 115, 49, 107, 112, 51, 121, 55, 51,
        53, 106, 119, 112, 113, 102, 108, 48, 108, 122, 57, 112, 97, 108, 122,
        107, 112, 116, 117, 104, 116, 104, 56, 119, 108, 108, 119, 56, 53, 52,
        103, 115, 18, 51, 101, 118, 109, 111, 115, 118, 97, 108, 111, 112, 101,
        114, 49, 107, 112, 51, 121, 55, 51, 53, 106, 119, 112, 113, 102, 108,
        48, 108, 122, 57, 112, 97, 108, 122, 107, 112, 116, 117, 104, 116, 104,
        56, 119, 108, 108, 114, 102, 109, 57, 102, 100, 26, 29, 10, 6, 97,
        101, 118, 109, 111, 115, 18, 19, 49, 48, 48, 48, 48, 48, 48, 48,
        48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 48, 18, 113, 10, 89,
        10, 79, 10, 40, 47, 101, 116, 104, 101, 114, 109, 105, 110, 116, 46,
        99, 114, 121, 112, 116, 111, 46, 118, 49, 46, 101, 116, 104, 115, 101,
        99, 112, 50, 53, 54, 107, 49, 46, 80, 117, 98, 75, 101, 121, 18,
        35, 10, 33, 3, 169, 240, 228, 126, 233, 117, 1, 65, 25, 244, 84,
        162, 8, 57, 93, 150, 124, 67, 6, 177, 247, 211, 57, 169, 81, 122,
        105, 227, 85, 155, 33, 195, 18, 4, 10, 2, 8, 1, 24, 1, 18,
        20, 10, 14, 10, 6, 97, 101, 118, 109, 111, 115, 18, 4, 50, 48,
        48, 48, 16, 192, 154, 12, 26, 12, 101, 118, 109, 111, 115, 95, 57,
        48, 48, 48, 45, 49,
    ])
    # fmt: on
    eip712 = decode_protobuf_sign_doc(encoded)
...
def test_throws_on_invalid_byte_payload():
    # Remove last byte from previous test
    # It was the last byte of chain id
    # fmt: off
    encoded = bytes([
        10, 173, 1, 10, 170, 1, 10, 35, 47, 99, 111, 115, 109, 111, 115,
        46, 115, 116, 97, 107, 105, 110, 103, 46, 118, 49, 98, 101, 116, 97,
