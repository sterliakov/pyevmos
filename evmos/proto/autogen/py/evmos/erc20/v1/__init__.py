...
class ToggleTokenConversionProposal(betterproto.Message):
    """
    ToggleTokenConversionProposal is a gov Content type to toggle the
...
class QueryTokenPairRequest(betterproto.Message):
    """
    QueryTokenPairRequest is the request type for the Query/TokenPair RPC
    method.
    """
...
class MsgConvertCoin(betterproto.Message):
    """
    MsgConvertCoin defines a Msg to convert a native Cosmos coin to a ERC20
    token
    """
