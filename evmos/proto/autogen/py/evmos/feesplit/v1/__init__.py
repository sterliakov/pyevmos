...
class QueryFeeSplitsRequest(betterproto.Message):
    """
    QueryFeeSplitsRequest is the request type for the Query/FeeSplits RPC
    method.
    """
...
class MsgUpdateFeeSplit(betterproto.Message):
    """
    MsgUpdateFeeSplit defines a message that updates the withdrawer address for
    a registered FeeSplit
    """
