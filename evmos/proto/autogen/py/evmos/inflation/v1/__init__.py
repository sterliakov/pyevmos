...
class InflationDistribution(betterproto.Message):
    ...
    It excludes the team vesting distribution, as this is minted once at
    genesis. The initial InflationDistribution can be calculated from the Evmos
    Token Model like this: mintDistribution1 = distribution1 / (1 -
    teamVestingDistribution) 0.5333333         = 40%           / (1 - 25%)
    """
...
class ExponentialCalculation(betterproto.Message):
    ...
    each period. Calculation reference: periodProvision = exponentialDecay
    *  bondingIncentive f(x)            = (a * (1 - r) ^ x + c)  *  (1 +
    max_variance - bondedRatio * (max_variance / bonding_target))
    """
...
class QueryEpochMintProvisionResponse(betterproto.Message):
    ...
    epoch_mint_provision: ___cosmos_base_v1_beta1__.DecCoin = betterproto.message_field(
        1
    )
    """
...
class QuerySkippedEpochsRequest(betterproto.Message):
    """
    QuerySkippedEpochsRequest is the request type for the Query/SkippedEpochs
    RPC method.
    """
...
class QueryCirculatingSupplyResponse(betterproto.Message):
    ...
    circulating_supply: ___cosmos_base_v1_beta1__.DecCoin = betterproto.message_field(1)
...
class QueryInflationRateRequest(betterproto.Message):
    """
    QueryInflationRateRequest is the request type for the Query/InflationRate
    RPC method.
    """
