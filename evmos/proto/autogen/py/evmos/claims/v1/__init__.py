...
class QueryTotalUnclaimedResponse(betterproto.Message):
    """
    QueryTotalUnclaimedResponse is the response type for the
    Query/TotalUnclaimed RPC method.
    """
...
class QueryClaimsRecordsRequest(betterproto.Message):
    """
    QueryClaimsRecordsRequest is the request type for the Query/ClaimsRecords
    RPC method.
    """
...
class QueryClaimsRecordResponse(betterproto.Message):
    """
    QueryClaimsRecordResponse is the response type for the Query/ClaimsRecord
    RPC method.
    """
