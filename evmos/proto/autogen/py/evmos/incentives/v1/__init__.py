...
class Incentive(betterproto.Message):
    ...
    allocations: list[___cosmos_base_v1_beta1__.DecCoin] = betterproto.message_field(2)
...
class RegisterIncentiveProposal(betterproto.Message):
    ...
    allocations: list[___cosmos_base_v1_beta1__.DecCoin] = betterproto.message_field(4)
    """denoms and percentage of rewards to be allocated"""
...
class QueryIncentivesRequest(betterproto.Message):
    ...
    pagination: ___cosmos_base_query_v1_beta1__.PageRequest = betterproto.message_field(
        1
    )
...
class QueryIncentiveRequest(betterproto.Message):
    """
    QueryIncentiveRequest is the request type for the Query/Incentive RPC
    method.
    """
...
class QueryGasMeterRequest(betterproto.Message):
    """
    QueryGasMeterRequest is the request type for the Query/Incentive RPC
    method.
    """
...
class QueryAllocationMeterRequest(betterproto.Message):
    """
    QueryAllocationMeterRequest is the request type for the
