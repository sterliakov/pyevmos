...
class RequestFinalizeBlock(betterproto.Message):
    ...
    proposer_address: bytes = betterproto.bytes_field(8)
    """
    proposer_address is the address of the public key of the original proposer of the
    block.
    """
...
class ResponseFinalizeBlock(betterproto.Message):
    ...
    """
    a list of updates to the validator set. These will reflect the validator set at
    current height + 2.
    """
    ...
    """
    app_hash is the hash of the applications' state which is used to confirm that
    execution of the transactions was
...
class ExtendedVoteInfo(betterproto.Message):
    ...
    """
    block_id_flag indicates whether the validator voted for a block, nil, or did not
    vote at all
    """
