...
class AuthorizationType(betterproto.Enum):
    ...
    """
    AUTHORIZATION_TYPE_CANCEL_UNBONDING_DELEGATION defines an authorization type for
...
class MsgCreateValidator(betterproto.Message):
    ...
    The validator address bytes and delegator address bytes refer to the same account
    while creating validator (defer
