...
class QueryAllBalancesRequest(betterproto.Message):
    ...
    """
    resolve_denom is the flag to resolve the denom into a human-readable form from the
    metadata.
...
class QueryDenomMetadataByQueryStringRequest(betterproto.Message):
    ...
    Query/DenomMetadata RPC method.
...
class QueryDenomMetadataByQueryStringResponse(betterproto.Message):
    ...
    method. Identical with QueryDenomMetadataResponse but receives denom as query string
    in request.
    """
...
class QueryDenomOwnersByQueryRequest(betterproto.Message):
    """
    QueryDenomOwnersByQueryRequest defines the request type for the DenomOwnersByQuery
    RPC query,
    which queries for a paginated set of all account holders of a particular
    denomination.
...
class QueryDenomOwnersByQueryResponse(betterproto.Message):
    """
    QueryDenomOwnersByQueryResponse defines the RPC response of a DenomOwnersByQuery RPC
    query.
    Since: cosmos-sdk 0.50.3
    """
...
class QueryStub(betterproto.ServiceStub):
    ...
    async def denom_metadata_by_query_string(
        self,
        query_denom_metadata_by_query_string_request: "QueryDenomMetadataByQueryStringRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None,
        ...
        return await self._unary_unary(
            ...
            query_denom_metadata_by_query_string_request,
            QueryDenomMetadataByQueryStringResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def denom_owners_by_query(
        self,
        query_denom_owners_by_query_request: "QueryDenomOwnersByQueryRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None,
        ...
        return await self._unary_unary(
            ...
            query_denom_owners_by_query_request,
            QueryDenomOwnersByQueryResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class QueryBase(ServiceBase):
    ...
    async def denom_owners_by_query(
        self, query_denom_owners_by_query_request: "QueryDenomOwnersByQueryRequest"
    ) -> "QueryDenomOwnersByQueryResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_denom_metadata_by_query_string(
        self,
        stream: "grpclib.server.Stream[QueryDenomMetadataByQueryStringRequest, QueryDenomMetadataByQueryStringResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.denom_metadata_by_query_string(request)
        await stream.send_message(response)
    ...
    async def __rpc_denom_owners_by_query(
        self,
        stream: "grpclib.server.Stream[QueryDenomOwnersByQueryRequest, QueryDenomOwnersByQueryResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.denom_owners_by_query(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/cosmos.bank.v1beta1.Query/DenomMetadataByQueryString": grpclib.const.Handler(
                self.__rpc_denom_metadata_by_query_string,
                grpclib.const.Cardinality.UNARY_UNARY,
            ...
            "/cosmos.bank.v1beta1.Query/DenomOwnersByQuery": grpclib.const.Handler(
                self.__rpc_denom_owners_by_query,
                grpclib.const.Cardinality.UNARY_UNARY,
