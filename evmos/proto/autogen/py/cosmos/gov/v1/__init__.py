...
class Params(betterproto.Message):
    ...
    """
    The cancel ratio which will not be returned back to the depositors when a proposal
    is cancelled.
    Since: cosmos-sdk 0.50
    """
    ...
    expedited_min_deposit: List["__base_v1_beta1__.Coin"] = betterproto.message_field(
        12
    )
    ...
    """
    The ratio representing the proportion of the deposit value minimum that must be met
    when making a deposit.
    Default value: 0.01. Meaning that for a chain with a min_deposit of 100stake, a
    deposit of 1stake would be
    required.
    Since: cosmos-sdk 0.50
    """
...
class GenesisState(betterproto.Message):
    ...
    constitution is an immutable string in genesis for a chain builder to lay out their
    vision, ideas and ideals.
    Since: cosmos-sdk 0.50
    """
...
class QueryStub(betterproto.ServiceStub):
    async def constitution(
        self,
        query_constitution_request: "QueryConstitutionRequest",
        *,
...
class MsgStub(betterproto.ServiceStub):
    ...
    async def cancel_proposal(
        self,
        msg_cancel_proposal: "MsgCancelProposal",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None,
...
class QueryBase(ServiceBase):
    async def constitution(
        self, query_constitution_request: "QueryConstitutionRequest"
    ) -> "QueryConstitutionResponse":
    ...
    async def __rpc_constitution(
        self,
        stream: "grpclib.server.Stream[QueryConstitutionRequest, QueryConstitutionResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.constitution(request)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            "/cosmos.gov.v1.Query/Constitution": grpclib.const.Handler(
                self.__rpc_constitution,
...
class MsgBase(ServiceBase):
    ...
    async def cancel_proposal(
        self, msg_cancel_proposal: "MsgCancelProposal"
    ) -> "MsgCancelProposalResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_cancel_proposal(
        self,
        stream: "grpclib.server.Stream[MsgCancelProposal, MsgCancelProposalResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.cancel_proposal(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/cosmos.gov.v1.Msg/CancelProposal": grpclib.const.Handler(
                self.__rpc_cancel_proposal,
                grpclib.const.Cardinality.UNARY_UNARY,
                MsgCancelProposal,
                MsgCancelProposalResponse,
            ),
