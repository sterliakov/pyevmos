...
class ControllerGenesisState(betterproto.Message):
    ...
    interchain_accounts: list[RegisteredInterchainAccount] = betterproto.message_field(
        2
    )
...
class InterchainAccount(betterproto.Message):
    ...
    base_account: ____cosmos_auth_v1_beta1__.BaseAccount = betterproto.message_field(1)
