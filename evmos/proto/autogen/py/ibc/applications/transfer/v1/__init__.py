...
class QueryDenomTraceRequest(betterproto.Message):
    ...
    """
    hash (in hex format) or denom (full denom with ibc prefix) of the denomination trace
    information.
    """
...
class QueryTotalEscrowForDenomRequest(betterproto.Message):
    """
    QueryTotalEscrowForDenomRequest is the request type for TotalEscrowForDenom RPC
    method.
    """
...
class QueryTotalEscrowForDenomResponse(betterproto.Message):
    """
    QueryTotalEscrowForDenomResponse is the response type for TotalEscrowForDenom RPC
    method.
    """
