...
class ConsensusStateWithHeight(betterproto.Message):
    ...
    consensus_state: betterproto_lib_google_protobuf.Any = betterproto.message_field(2)
    """consensus state"""
...
class QueryConsensusStateResponse(betterproto.Message):
    ...
    consensus_state: betterproto_lib_google_protobuf.Any = betterproto.message_field(1)
    """
...
class MsgUpgradeClient(betterproto.Message):
    ...
    consensus_state: betterproto_lib_google_protobuf.Any = betterproto.message_field(3)
    """
